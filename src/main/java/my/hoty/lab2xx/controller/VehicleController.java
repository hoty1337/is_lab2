...
import my.hoty.lab2xx.entity.VehicleType;
...
import my.hoty.lab2xx.service.VehicleService;
...
public class VehicleController {
    ...
    public String filterVehicle(Model model, @RequestParam String field, @RequestParam String filter, @RequestParam int sort) {
